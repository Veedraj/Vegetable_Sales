...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests().antMatchers("/product-section/products").permitAll()
				...
				.antMatchers(HttpMethod.POST, "/product-section/**").permitAll()
				.antMatchers(HttpMethod.PUT, "/product-section/**").permitAll()
				.antMatchers(HttpMethod.DELETE, "/product-section/**").permitAll()
