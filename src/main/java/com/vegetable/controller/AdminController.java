...
public class AdminController {
	...
	public ResponseEntity<List<Customer>> deleteCustomerById(@PathVariable("customerId") Long customerId) throws CustomerNotFoundException{
	...
	public ResponseEntity<List<Payment>> deletePaymentById(@PathVariable("paymentId") Long paymentId) throws PaymentNotFoundException{
